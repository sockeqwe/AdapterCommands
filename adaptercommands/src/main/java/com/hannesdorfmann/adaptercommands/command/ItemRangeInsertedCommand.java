...
/**
 * This command simply calls {@link RecyclerView.Adapter#notifyItemRangeInserted(int, int)}
 *
 * @author Hannes Dorfmann
 * @since 1.0
 */
public class ItemRangeInsertedCommand implements AdapterCommand {

  final int startPosition;
  final int itemCount;

  public ItemRangeInsertedCommand(int startPosition, int itemCount) {
    if (startPosition < 0) {
  ...
  @Override public boolean equals(Object o) {
    ...
    ItemRangeInsertedCommand that = (ItemRangeInsertedCommand) o;
  ...
  @Override public String toString() {
    return "ItemRangeInsertedCommand{" +
